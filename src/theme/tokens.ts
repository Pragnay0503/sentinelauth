 ...
 * TypeScript definitions matching tokens.css and tokens.js.
 */
...
export interface DesignTokens {
  colors: {
    ...
    primaryBlueActive: string;
    signalAmber: string;
    alertRed: string;
    verifiedGreen: string;
    neutralGrey: string;
    ink: string;
    inkMuted: string;
    panelHover: string;
    panelActive: string;
    primaryBlueMuted: string;
    primaryBlueGlow: string;
    signalAmberMuted: string;
    signalAmberGlow: string;
    alertRedMuted: string;
    verifiedGreenMuted: string;
    neutralGreyMuted: string;
  };
  spacing: {
    1: string;
    2: string;
